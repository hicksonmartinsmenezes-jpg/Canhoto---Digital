  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative grid size-10 place-items-center border border-slate-200 bg-white text-[#0A1F44] transition-colors hover:bg-slate-50"
      >
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute right-0 z-50 mt-2 w-80 border border-slate-200 bg-white shadow-lg">
