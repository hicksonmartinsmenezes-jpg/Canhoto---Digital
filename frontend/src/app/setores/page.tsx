  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">
        O controle das entregas é feito por um único setor: a Expedição.
      </p>
      <div className="mt-8 border border-slate-200 bg-white p-6 text-sm text-slate-500">
        ...
        Expedição efetivamente opera o sistema de entregas, então esse
        conceito ficou fixo em vez de virar um cadastro. Os demais
        departamentos da empresa (Financeiro, RH etc.) podem aparecer como
        setor de origem de um colaborador, mas não administram entregas aqui.
      </div>
    </div>
  );
}
